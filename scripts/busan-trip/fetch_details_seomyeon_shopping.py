...
西面 逛街/景點/母嬰用品 spots. Same technique as
scripts/busan-trip/fetch_details_busan.py.

FINAL_LIST_PATH: JSON shaped like {"逛街": ["exact candidate name", ...], ...}

Usage (CI): GOOGLE_PLACES_API_KEY=... python3 scripts/busan-trip/fetch_details_seomyeon_shopping.py
"""
import json, os, urllib.request, urllib.error, time

CANDIDATES_PATH = os.environ.get("SEOMYEON_CANDIDATES_PATH", "candidate-results/seomyeon-shopping-candidates.json")
FINAL_LIST_PATH = os.environ.get("SEOMYEON_FINAL_LIST_PATH", "candidate-results/seomyeon-shopping-final-list.json")
OUT_PATH = os.environ.get("SEOMYEON_DETAILS_PATH", "candidate-results/seomyeon-shopping-details.json")
