...
dinner spots near Haeundae Station. Same technique as
scripts/busan-trip/fetch_details_busan_hotel_breakfast.py.

FINAL_LIST_PATH: JSON array of exact candidate names to fetch.

Usage (CI): GOOGLE_PLACES_API_KEY=... python3 scripts/busan-trip/fetch_details_haeundae_station_dinner.py
"""
import json, os, urllib.request, urllib.error, time

CANDIDATES_PATH = os.environ.get("HAEUNDAE_STATION_CANDIDATES_PATH", "candidate-results/haeundae-station-dinner-candidates.json")
FINAL_LIST_PATH = os.environ.get("HAEUNDAE_STATION_FINAL_LIST_PATH", "candidate-results/haeundae-station-dinner-final-list.json")
OUT_PATH = os.environ.get("HAEUNDAE_STATION_DETAILS_PATH", "candidate-results/haeundae-station-dinner-details.json")
