...
靑沙浦 restaurants/shops. Same technique as
scripts/busan-trip/fetch_details_haeundae_station_dinner.py.

FINAL_LIST_PATH: JSON shaped like {"餐廳": ["exact candidate name", ...], "逛街": [...]}

Usage (CI): GOOGLE_PLACES_API_KEY=... python3 scripts/busan-trip/fetch_details_cheongsapo.py
"""
import json, os, urllib.request, urllib.error, time

CANDIDATES_PATH = os.environ.get("CHEONGSAPO_CANDIDATES_PATH", "candidate-results/cheongsapo-candidates.json")
FINAL_LIST_PATH = os.environ.get("CHEONGSAPO_FINAL_LIST_PATH", "candidate-results/cheongsapo-final-list.json")
OUT_PATH = os.environ.get("CHEONGSAPO_DETAILS_PATH", "candidate-results/cheongsapo-details.json")
...
for name in wanted:
    ...
    d['_distance_m'] = rec.get('distance_m')
