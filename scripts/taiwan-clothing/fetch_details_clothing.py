...
list of Taiwan clothing-store candidates. Same technique as
scripts/busan-trip/fetch_details_busan.py (NoRedirect photo-fetch pattern,
Sunday=0->Monday=0 hours conversion).

FINAL_LIST_PATH: JSON written by the workflow's selection step, shaped like
{"男裝": ["exact candidate name", ...], "女裝": [...], ...}

Usage (CI): GOOGLE_PLACES_API_KEY=... python3 scripts/taiwan-clothing/fetch_details_clothing.py
"""
import json, os, urllib.request, urllib.error, time

CANDIDATES_PATH = os.environ.get("TW_CLOTHING_CANDIDATES_PATH", "candidate-results/tw-clothing-candidates.json")
FINAL_LIST_PATH = os.environ.get("TW_CLOTHING_FINAL_LIST_PATH", "candidate-results/tw-clothing-final-list.json")
OUT_PATH = os.environ.get("TW_CLOTHING_DETAILS_PATH", "candidate-results/tw-clothing-details.json")
